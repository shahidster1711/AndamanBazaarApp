/*
Rollback / restore plan (indexes dropped in this migration):

If you need to restore any dropped index quickly, run:
  supabase/migrations/017_database_linter_fixes.rollback.sql

That file contains the original CREATE INDEX statements captured from the DB
(or from the original migrations) to ensure definitions match exactly.
*/
