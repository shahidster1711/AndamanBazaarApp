            ...
            return (
                <div className="h-screen bg-white flex flex-col items-center justify-center p-6">
                    <div className="text-center max-w-md">
                        ...
                        <h1 className="text-2xl font-black text-slate-800 mb-3 uppercase tracking-tight">You're Offline</h1>
                        <p className="text-slate-500 mb-8">Check your internet connection and try again. The app will reconnect automatically.</p>
                        <div className="inline-block bg-amber-50 px-6 py-3 rounded-2xl">
                            <span className="text-[10px] font-black text-amber-700 uppercase tracking-widest">Waiting for connection…</span>
                        </div>
                    </div>
                </div>
            );
            ...
            return (
                <div className="h-screen bg-white flex flex-col items-center justify-center p-6">
                    <div className="text-center max-w-md">
                        ...
                        <h1 className="text-2xl font-black text-slate-800 mb-3 uppercase tracking-tight">Something Went Wrong</h1>
                        <p className="text-slate-500 mb-8">An unexpected error occurred. This has been logged and our team will look into it.</p>
                        <button
