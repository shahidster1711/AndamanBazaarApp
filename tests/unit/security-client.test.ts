...
describe('Client Security Utilities', () => {
  ...
  describe('Input Sanitization', () => {
    ...
    it('should handle arrays', () => {
      const input = ['<script>alert("xss")</script>', 'javascript:alert(1)', 'normal text']
      const sanitized = sanitizeInput(input)
  ...
  describe('File Upload Validation', () => {
    ...
    it('should validate file extensions', () => {
      const invalidFile = new File(['content'], 'test.php', { type: 'image/jpeg' })
      const result = validateFileUpload(invalidFile)
      expect(result.isValid).toBe(false)
  ...
  describe('Suspicious Activity Detection', () => {
    it('should detect bot user agents', () => {
      ...
      const result = detectSuspiciousActivity(userAgent, '192.168.1.1', ['normal browsing'])
    ...
    it('should detect SQL injection patterns', () => {
      ...
      const result = detectSuspiciousActivity(userAgent, '192.168.1.1', behavior)
      expect(result).toBe(true)
    })
