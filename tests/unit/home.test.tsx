...
const Home = () => (
  <main>
    ...
    <section>
      <h2><span>Featured</span><span>Picks</span></h2>
      <span>Top rated island treasures</span>
    </section>
    <section>
      <h2><span>Today's</span><span>Hot Picks</span></h2>
    ...
    <section>
      ...
      <span>Nov–May is peak season. Find the best experiences, stays and local products.</span>
...
describe('Home Component', () => {
  ...
  it('renders hero section with correct content', () => {
    ...
    expect(screen.getByPlaceholderText('Search mobiles, scooters...')).toBeTruthy()
  })
