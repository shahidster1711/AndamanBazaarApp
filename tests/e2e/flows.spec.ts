...
test.describe('Authentication Flow', () => {
  ...
  test('should display login form by default', async ({ page }) => {
    await expect(page.getByRole('heading', { name: 'AndamanBazaar' })).toBeVisible()
  ...
  test('should switch to sign up form', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: 'Create Island Account' })).toBeVisible()
  })
...
test.describe('Home Page', () => {
  ...
  test('should display hero section', async ({ page }) => {
    ...
    await expect(page.getByPlaceholder('Search mobiles, scooters...')).toBeVisible()
  })

  test('should display categories section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: 'Browse Island Categories' })).toBeVisible()
  ...
  test('should display flash deals section', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'View Flash Deals' })).toBeVisible()
  })
  ...
  test('should display hot picks section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: "Today's Hot Picks" })).toBeVisible()
  ...
  test('should display verified sellers section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: 'Island Verified Sellers' })).toBeVisible()
    await expect(page.getByText('GPS-verified locals from across the Andaman Islands')).toBeVisible()
    await expect(page.getByRole('link', { name: 'Browse verified listings' })).toBeVisible()
  })

  test('should display fresh arrivals section', async ({ page }) => {
    await expect(page.getByRole('heading', { name: 'Fresh Arrivals' })).toBeVisible()
  ...
  test('should display seasonal spotlight section', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Tourist Season is Here' })).toBeVisible()
    await expect(page.getByRole('link', { name: 'Explore Season Picks' })).toBeVisible()
  })
  ...
  test('should have proper meta tags', async ({ page }) => {
    await expect(page.locator('meta[name="description"]')).toHaveAttribute('content', /Andaman Bazaar/)
    await expect(page.locator('meta[property="og:title"]')).toHaveAttribute('content', /Andaman Bazaar/)
  })
